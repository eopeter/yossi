...
class CallProgressPage extends StatefulWidget {
  @override
  _CallProgressPageState createState() => _CallProgressPageState();
}

class _CallProgressPageState extends State<CallProgressPage> {
  var speaker = false;
  var mute = false;
  var isEnded = false;
